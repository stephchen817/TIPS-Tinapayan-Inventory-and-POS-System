<?php include "dbConnection.php";
    ...
    AS TotalAmt FROM price INNER JOIN invoice_details ON invoice_details.prodID = price.prodID INNER JOIN invoice 
    ON invoice_details.invoiceID = invoice.invoiceID GROUP BY invoice_details.invoiceID HAVING 
    MONTH(invoiceDate) = MONTH(CURRENT_DATE()) AND YEAR(invoiceDate) = YEAR(CURRENT_DATE())";    
    ...
    <div class='container-fluid' id="header1">
            ...
            <main>
                <section class='sec-1' id='panel'>
                    <div class='container-xl'>
                        ...
                        <center>
                            <h2 style="color:white;font-size:25px;"class='loggedIn'>MONTHLY</h2>
                            <br>
                        </center>
        ...
        <div>
            <?php
                ...
                WHERE MONTH(invoiceDate) = MONTH(CURRENT_DATE()) AND YEAR(invoiceDate) = YEAR(CURRENT_DATE())";
