    ...
    <body id = 'reppage' style = "background-color: #FFF3E1;">
        ...
        <div class='row'>
            ...
            <div class="thumbnail text-center" id="sales">
                <a href='invoice.php'>
                <img src="images/cashier.png" id='icon' alt="" class="img-responsive" style = "margin-left: 380px;margin-top:150px; height: 240px; width: 250px;">
                <div class="caption" id='caption'>
				<p style = "color: black; margin-left: 335px; margin-top: -18px; font-size: 20px; color: white;"> Sales  </p>
					<p id="sales-text"></p>
                </div>
                </a>
            </div>
            ...
            <div class="thumbnail text-center" id="user">
                ...
                <img src="images/accounts.png" id='icon' alt="" class="img-responsive" style = "margin-top:140px; margin-left: 25px; margin-right: 33px; height: 280px; width: 290px;">
                <div class="caption" id='caption'>
				<p style = "color: black; margin-left: 5px; margin-top: -18px; font-size: 20px; color: white;"> Switch User  </p>
