        ...
        <main>
            <section class='sec-1' id='panel'>
                <div class='container-xl'>
                    ...
                    <center>
                        <h2 class='loggedIn' id='username'><?php echo $_SESSION["loginUser"]; ?></h3>
                            <br>
                    </center>
                    <button type="button" name="add" id="add" class="btn btn-success btn-xs">Add Invoice</button>
                    <form action='menu.php'>
                        <button id='return' type="button" class="btn-block btn-info btn-secondary">
                            Return
                        </button>
                    </form>
                </div>
            ...
            <section class='sec-2' id='table'>
                <form method="post" id="user_form">
                    ...
                    <div align="center">
                        <input type="submit" name="insert" id="insert" class="btn btn-primary" value="Save Invoice Details" ahref here />
                    </div>
                </form>
                <br />
            </section>
