<?php include "dbConnection.php";
   ...
   $qry="SELECT invoice_details.invoiceID, invoice.invoiceDate, invoice.customerName, invoice.customerAddress, invoice_details.prodID, 
   ...
   HAVING YEARWEEK(invoiceDate) = YEARWEEK(NOW())";
...
<body id='reppage'>
    <div class='container-fluid' id="header1">
            ...
            <main>
                <section class='sec-1' id='panel'>
                    <div class='container-xl'>
                        ...
                        <center>
                            <h2 style="color:white;font-size:25px;"class='loggedIn'>WEEKLY</h2>
                            <br>
                        </center>
        ...
        <?php
                ...
                WHERE YEARWEEK(invoiceDate) = YEARWEEK(NOW())";
