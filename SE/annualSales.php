<?php include "dbConnection.php";
    ...
    invoice_details.invoiceID = invoice.invoiceID GROUP BY invoice_details.invoiceID HAVING YEAR(invoiceDate) = YEAR(CURDATE())";   
            ...
            <main>
                <section class='sec-1' id='panel'>
                    <div class='container-xl'>
                        ...
                        <center>
                        <h2 style="color:white;font-size:25px;"class='loggedIn'>ANNUAL</h2>
                            <br>
                        </center>
